    ...
    <div id="PaymentOptions" class="flex flex-col rounded-[30px] border border-[#F1F2F6] p-5 gap-4 mx-5">
        <div id="TabButton-Container"
            ...
            <label class="tab-link group relative flex flex-col justify-between gap-4"
                ...
                <input type="radio" name="payment_methode" value="down_payment"
            ...
            <label class="tab-link group relative flex flex-col justify-between gap-4"
                ...
                <input type="radio" name="payment_methode" value="full_payment"
        ...
        <div id="TabContent-Container">
            @php
            $subTotal = $room->price_per_month * $transaction['duration']; // contoh dari database
            $ppn = $subTotal * 0.11;
            $insurance = $subTotal * 0.01;
            $total = $subTotal + $ppn + $insurance;

            $downPaymentPercent = $total * 0.3;
            ...
            <div id="DownPayment-Tab" class="tab-content flex flex-col gap-4">
                ...
                <div class="flex items-center justify-between">
                    ...
                    <p id="downPaymentPrice" class="font-semibold">Rp {{number_format($downPaymentPercent,  0 ,',', '.')}}</p>
                </div>
            </div>
