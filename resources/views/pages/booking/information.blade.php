...
<form action="{{route('booking.information.save', $boardingHouse->slug)}}" method="POST" class="relative flex flex-col gap-6 mt-5 pt-5 bg-[#F5F6F8]">
    ...
    <div id="InputContainer" class="flex flex-col gap-[18px]">
        <div class="flex flex-col w-full gap-2 px-5">
            ...
            <label
                class="flex items-center w-full rounded-full p-[14px_20px] gap-3 bg-white focus-within:ring-1 focus-within:ring-[#91BF77] transition-all duration-300 " @error('name') style="border: 1.5px solid #c30000;"
                @enderror>
                <img src="{{asset('assets/images/icons/profile-2user.svg')}}" class="w-5 h-5 flex shrink-0" alt="icon">
        ...
        <div class="flex flex-col w-full gap-2 px-5">
            ...
            <label
                class="flex items-center w-full rounded-full p-[14px_20px] gap-3 bg-white focus-within:ring-1 focus-within:ring-[#91BF77] transition-all duration-300" @error('email') style="border: 1.5px solid #c30000;"
                @enderror>
        ...
        <div class="flex flex-col w-full gap-2 px-5">
            <p class="font-semibold text-red-500">Phone No</p>
            <label
                class="flex items-center w-full rounded-full p-[14px_20px] gap-3 bg-white focus-within:ring-1 focus-within:ring-[#91BF77] transition-all duration-300" @error('phone_number') style="border: 1.5px solid #c30000;"
                @enderror>
