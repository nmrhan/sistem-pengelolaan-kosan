...
<div id="TopNav" class="relative flex items-center justify-between px-5 mt-[60px]">
    <a href="javascript:history.go(-1)" class="w-12 h-12 flex items-center justify-center shrink-0 rounded-full overflow-hidden bg-white">
...
<div class="accordion group flex flex-col rounded-[30px] p-5 bg-[#F5F6F8] mx-5 mt-5 overflow-hidden has-[:checked]:!h-[68px] transition-all duration-300">
    ...
    @php
    $subTotal = $transaction->room->price_per_month * $transaction['duration']; // dari database
    $ppn = $subTotal * 0.11;
    ...
    <div class="flex flex-col gap-4 pt-[22px]">
        ...
        <div class="flex items-center justify-between">
            ...
            @else
            <p class="font-semibold">Rp {{number_format($downPaymentPercent, 0, ',', '.')}}</p>
            @endif
