...
<div id="Header" class="relative flex items-center justify-between gap-2 px-5 mt-[18px]">
    <div class="flex flex-col gap-[6px]">
        <h1 class="font-bold text-[32px] leading-[48px]">Filter in {{$category->name}}</h1>
        <p class="text-ngekos-grey">Tersedia {{$category->boardingHouses->count()}} Tempat</p>
    </div>
        ...
        <div
            ...
            <div class="flex flex-col gap-3 w-full">
                ...
                <div class="flex items-center gap-[6px]">
                    ...
                    <p class="text-sm text-ngekos-grey">@foreach($house->rooms->take(2) as $room)
