            ...
            <a href="{{route('category.show', $category->slug)}}" class="card">
                <div
                    ...
                    <div class="flex flex-col gap-[2px]">
                        ...
                        <p class="text-sm text-ngekos-grey">{{$category->boardingHouses->count()}} Place</p>
                    </div>
                </div>
            </a>
        </div>
                        ...
                        <div class="flex flex-col gap-3">
                            ...
                            <div class="flex items-center gap-[6px]">
                                ...
                                <p class="text-sm text-ngekos-grey">
                                    @foreach($boardingHouse->rooms->take(2) as $room)
                                    {{$room->capacity}} People<br>
                                    @endforeach
                                </p>
        ...
        <a href="{{route('city.show', $city->slug)}}" class="card">
            <div
                ...
                <div class="flex flex-col gap-[2px]">
                    ...
                    <p class="text-sm text-ngekos-grey">{{$city->boardingHouses->count()}} Place</p>
                </div>
            </div>
        </a>
        @endforeach
                ...
                <div class="flex flex-col gap-3 w-full">
                    ...
                    <div class="flex items-center gap-[6px]">
                        <img src="assets/images/icons/profile-2user.svg" class="w-5 h-5 flex shrink-0"
                            alt="icon">
                        <p class="text-sm text-ngekos-grey">
                            @foreach($house->rooms->take(2) as $room)
                            {{$room->capacity}} People<br>
                            @endforeach
                        </p>
                    </div>
